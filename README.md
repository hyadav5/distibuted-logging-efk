...
• The docker engine is configured to log messages. So all the containers will log their messages in the /var/log/container folder with name as -.log file.
...
• terminal> helm install /logging-fluentd-ds -f
...
• terminal> helm install /elastic-curator -f
